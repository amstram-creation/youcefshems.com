...
<section class="page-section cta" id="biographie">
  ...
  <div class="cta-inner bg-faded  rounded">
      ...
      <p>Youcef Shems (<em>shems signifie soleil, surnom donné pour sa joie de vivre</em>), est un jeune artiste franco-marocain né dans le Nord de la France. Autodidacte dans l’âme, il est à la fois auteur, compositeur et interprète.</p>
      <p>Shems a grandi dans un univers musical poétique bédouin, où <q>les secrets du pouvoir de la musique réside dans l’alliance du verbe et du son</q> <a href="#bio_footnote">*</a>. Son papa passionné par la musique de la région, <em>Beni guil</em> (nomades de l’Est Marocain), chantait lors des évènements locaux accompagné par l’instrument ancestral qu’est la Gasba, flûte en roseau. Il s’inspirait des chanteurs traditionnels tels que cheikh Hamada, Khlefi Ahmed, Cheikh el Madani et bien d’autres abordant de manière subtile des thèmes liés à la condition humaine dans une société traditionnelle. Cette musique s’inspirait des vécus populaires laissant libre court à l’imagination des auditeurs à chercher le sens caché des mots. Cette période a marqué son enfance et Shems puise sa créativité libre de cet héritage poétique et musical.</p>
      <p>Jeune adulte, il chantait lors des fêtes reprenant les répertoires connus pour ensuite personnaliser les chansons poétiques traditionnelles par des arrangements aux sonorités d’aujourd’hui créant un univers musical particulier.</p>
      <img class="img-fluid my-3" src="assets/img/biographie.jpg" alt="Photo enfance"/>
      <p>Son parcours sera marqué par cette période, Shems veut concilier l’héritage que représente sa passion pour l’art du verbe et la modernité faisant partie de son quotidien. Il n’oppose pas ces univers, il les unis à travers ses compositions et ses clips où il met en scène les questions qui marquent la jeunesse.</p>
      <p>Shems se reconnaît dans le style pop raï, il ouvre son champ musical et se professionnalise en prenant des cours de musique et de chant. Son projet artistique est devenu une passion qui occupe tout son temps libre.  </p>
      <p>Son premier single « Demdouma » sort en janvier 2018 et aborde de manière humoristique la thématique du mariage arrangé, ce clip dépasse en quelques semaines le million de vues sur les réseaux sociaux.</p>
      <p>Encouragé par cette belle expérience, il a composé trois duo qui sont de véritables succès en Europe et au Maghreb, chantant en plusieurs langues (français, arabe, néerlandais, rif, ..) il rapproche les différentes communautés des rives de la méditerranée.</p>
      <p>En prévision de la coupe du Monde 2022, il a sorti sa chanson "Allez le Maroc" pour supporter son pays d’origine. Le Maroc, outsider de la CDM 2022, a excellé et cette chanson a été scandée dans les rues du Maroc et d’Europe.</p>
      <p class="mt-4">* Des hauts plateaux aux oasis : La chanson saharienne. Abdelhafid Hamdi-Cherif</p>
  </div>
  </div>
</section>
